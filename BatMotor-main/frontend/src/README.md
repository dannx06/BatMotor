...
| `api/services/*.js` | Um ficheiro por domínio: `auth`, `materials`, `suppliers`, `movements`, `reports`, `users`, `profileAdmin`. |
...
CSS global (`app.css`), texto, botões, relatórios, overrides do login.
